...
import com.mc.mcsq.common.exception.ApiAsserts;
...
import com.mc.mcsq.model.dto.LoginDTO;
import com.mc.mcsq.model.dto.RegisterDTO;
...
import com.mc.mcsq.utils.MD5Utils;
...
public class IUmsUserServiceImpl extends ServiceImpl<UmsUserMapper, UmsUser> implements IUmsUserService {
    ...
    public String executeLogin(LoginDTO dto) {
        ...
        try {
            ...
            token = JwtUtil.generateToken(String.valueOf(user.getUsername()),user.getRoleId());
        } catch (Exception e) {
